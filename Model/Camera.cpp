...
f3Vector::ElType CameraInfo::GetFOVX() { return 2 * atan(wR / Near); }

f3Vector::ElType CameraInfo::GetFOVY() { return 2 * atan(wT / Near); }

void CameraInfo::Xform(const Matrix44<typename f3Vector::ElType>& M) { WorldToEye = WorldToEye * M; }
