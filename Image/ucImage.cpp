...
void ucImage::Save(const char *fname) const
{
    ImageLoadSave saver;
...
void ucImage::SaveGIF(const char *fname, int MaxColorsWanted) const
{
    ImageLoadSave saver;
    saver.SetImage(Pix, wid, hgt, chan);
    saver.SaveGIF(fname, MaxColorsWanted);
    saver.Pix = NULL; saver.wid = saver.hgt = saver.chan = 0;
}
void ucImage::SavePPM(const char *fname) const
{
    ImageLoadSave saver;
    saver.SetImage(Pix, wid, hgt, chan);
    saver.SavePPM(fname);
...
void ucImage::SaveBMP(const char *fname) const
{
    ImageLoadSave saver;
    saver.SetImage(Pix, wid, hgt, chan);
    saver.SaveBMP(fname);
...
void ucImage::SaveTGA(const char *fname) const
{
    ImageLoadSave saver;
    saver.SetImage(Pix, wid, hgt, chan);
    saver.SaveTGA(fname);
...
#ifdef DMC_USE_TIFF
void ucImage::SaveTIFF(const char *fname) const
{
    ImageLoadSave saver;
    saver.SetImage(Pix, wid, hgt, chan);
    saver.SaveTIFF(fname);
    saver.Pix = NULL; saver.wid = saver.hgt = saver.chan = 0;
}
#endif
#ifdef DMC_USE_JPEG
void ucImage::SaveJPEG(const char *fname) const
{
    ImageLoadSave saver;
    saver.SetImage(Pix, wid, hgt, chan);
    saver.SaveJPEG(fname);
    saver.Pix = NULL; saver.wid = saver.hgt = saver.chan = 0;
}
#endif
#ifdef DMC_USE_PNG
void ucImage::SavePNG(const char *fname) const
{
    ImageLoadSave saver;
    saver.SetImage(Pix, wid, hgt, chan);
    saver.SavePNG(fname);
