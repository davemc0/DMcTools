...
//////////////////////////////////////////////////////////////////////
bool ImageLoadSave::LoadGIF(const char *fname, bool WantPaletteInds)
{
    GIFInfo pi;
...
nomatch:
    ...
    //////////////////////////////////////////////////////////////////////
    int WriteGIF(const char *fname, int wid, int hgt, byte *Pix, int MaxColorsWanted = 256,
...
bool ImageLoadSave::SaveGIF(const char *fname, int MaxColorsWanted) const
{
    if(Pix==NULL || chan < 1 || wid < 1 || hgt < 1) {
        cerr << "Image is not empty. Not saving.\n";
        return DMC_ERROR;
    }
    ...
    GIFWriter gw;
    if(gw.WriteGIF(fname, wid, hgt, (unsigned char *)Pix, MaxColorsWanted, (chan==1),
