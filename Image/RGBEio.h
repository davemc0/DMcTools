...
#define STDPRIMS                                                               \
    {                                                                          \
        CIE_x_r, CIE_y_r, CIE_x_g, CIE_y_g, CIE_x_b, CIE_y_b, CIE_x_w, CIE_y_w \
    }
...
#define primsval(p, hl)                                                                                                                                       \
    sscanf(hl + LPRIMARYSTR, "%f %f %f %f %f %f %f %f", &(p)[RED][CIEX], &(p)[RED][CIEY], &(p)[GRN][CIEX], &(p)[GRN][CIEY], &(p)[BLU][CIEX], &(p)[BLU][CIEY], \
           &(p)[WHT][CIEX], &(p)[WHT][CIEY])
#define fputprims(p, fp)                                                                                                                                    \
    fprintf(fp, "%s %.4f %.4f %.4f %.4f %.4f %.4f %.4f %.4f\n", PRIMARYSTR, (p)[RED][CIEX], (p)[RED][CIEY], (p)[GRN][CIEX], (p)[GRN][CIEY], (p)[BLU][CIEX], \
            (p)[BLU][CIEY], (p)[WHT][CIEX], (p)[WHT][CIEY])
