...
template <class Image_T>
void tSave(const char *fname, const Image_T &Img)
{
    ...
    if(exts==GIF_ || exts==JPG_ || exts==BMP_) { // 1 3 uc
        ...
        if(!Img.is_integer()) {
            if(ch!=1 && ch!=3) OutImg = new tImage<tPixel<float, 3> >(Img);
        } else
            if((Img.size_element()!=2 && ch<=4) || (isUC && ch!=1 && ch!=3 && ch!=4)) OutImg = new tImage<tPixel<unsigned char, 3> >(Img);
    } 
...
template void tSave(const char *fname, const uc1Image &outImg);
template void tSave(const char *fname, const uc2Image &outImg);
template void tSave(const char *fname, const uc3Image &outImg);
template void tSave(const char *fname, const uc4Image &outImg);
template void tSave(const char *fname, const us1Image &outImg);
template void tSave(const char *fname, const us2Image &outImg);
template void tSave(const char *fname, const us3Image &outImg);
template void tSave(const char *fname, const us4Image &outImg);
template void tSave(const char *fname, const ui1Image &outImg);
//template void tSave(const char *fname, const ui2Image &outImg);
//template void tSave(const char *fname, const ui3Image &outImg);
//template void tSave(const char *fname, const ui4Image &outImg);
template void tSave(const char *fname, const f1Image &outImg);
//template void tSave(const char *fname, const f2Image &outImg);
template void tSave(const char *fname, const f3Image &outImg);
//template void tSave(const char *fname, const f4Image &outImg);
template void tSave(const char *fname, const h1Image &outImg);
//template void tSave(const char *fname, const h2Image &outImg);
template void tSave(const char *fname, const h3Image &outImg);
//template void tSave(const char *fname, const h4Image &outImg);
