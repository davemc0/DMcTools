...
class basePixel
{
    ...
    // five data types unless you change this class. I believe that's only
    ...
    static void pixel_cast(half &d, const unsigned char &s) {d = s/float(0xff);}
    static void pixel_cast(float &d, const unsigned char &s) {d = s/float(0xff);}
    static void pixel_cast(double &d, const unsigned char &s) {d = s/double(0xff);}
    
    static void pixel_cast(unsigned char &d, const unsigned short &s) {d = ((s>>7)+1)>>1;}
    static void pixel_cast(unsigned short &d, const unsigned short &s) {d = s;}
    static void pixel_cast(unsigned int &d, const unsigned short &s) {unsigned int t=s; d=(t<<16)|t;}
    static void pixel_cast(half &d, const unsigned short &s) {d = s/float(0xffff);}
    static void pixel_cast(float &d, const unsigned short &s) {d = s/float(0xffff);}
    static void pixel_cast(double &d, const unsigned short &s) {d = s/double(0xffff);}
    
    static void pixel_cast(unsigned char &d, const unsigned int &s) {d = ((s>>23)+1)>>1;}
    static void pixel_cast(unsigned short &d, const unsigned int &s) {d = ((s>>15)+1)>>1;}
    static void pixel_cast(unsigned int &d, const unsigned int &s) {d = s;}
    static void pixel_cast(half &d, const unsigned int &s) {d = s/double(0xffffffff);}
    ...
    static unsigned char pixel_max(unsigned char) {return 0xff;}
    static unsigned short pixel_max(unsigned short) {return 0xffff;}
    static unsigned int pixel_max(unsigned int) {return 0xffffffff;}
    static float pixel_max(float) {return 1.0f;}
    static double pixel_max(double) {return 1.0;}
...
#define LUM_BF 0.0851
    ...
    static unsigned char _doLum(const unsigned char r, const unsigned char g, const unsigned char b)
    {
        ...
        pixel_cast(wr, LUM_RF); pixel_cast(wg, LUM_GF); pixel_cast(wb, LUM_BF);
