...
#define ASSERT_RM(condition, msg)                                                                        \
    {                                                                                                    \
        if (!(condition)) {                                                                              \
            ...
            Er << "Assert_R: (" << (#condition) << ") at " << __FILE__ << ":" << __LINE__ << " " << msg; \
...
#define ASSERT_R(condition)                                                                \
    {                                                                                      \
        if (!(condition)) {                                                                \
            std::ostringstream Er;                                                         \
            Er << "Assert_R: (" << (#condition) << ") at " << __FILE__ << ":" << __LINE__; \
            throw DMcError(Er.str());                                                      \
        }                                                                                  \
    }
...
#define ASSERT_DM(condition, msg)                                                                         \
    {                                                                                                     \
        if (!(condition)) {                                                                               \
            std::ostringstream Er;                                                                        \
            Er << "Assert_DM: (" << (#condition) << ") at " << __FILE__ << ":" << __LINE__ << " " << msg; \
            throw DMcError(Er.str());                                                                     \
        }                                                                                                 \
    }
...
#define ASSERT_D(condition)                                                                \
    {                                                                                      \
        if (!(condition)) {                                                                \
            std::ostringstream Er;                                                         \
            Er << "Assert_D: (" << (#condition) << ") at " << __FILE__ << ":" << __LINE__; \
            throw DMcError(Er.str());                                                      \
        }                                                                                  \
    }
...
#define GL_ASSERT()                                                                                            \
    {                                                                                                          \
        ...
        while ((DMC_err = glGetError()) != GL_NO_ERROR) {                                                      \
            std::ostringstream Er;                                                                             \
            Er << "OpenGL error: " << (char*)gluErrorString(DMC_err) << " at " << __FILE__ << ":" << __LINE__; \
            throw DMcError(Er.str());                                                                          \
        }                                                                                                      \
    }
