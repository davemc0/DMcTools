...
template<class Elem_T>
DMC_DECL t3Vector<Elem_T> Abs(const t3Vector<Elem_T> &v)
{
...
template<class Elem_T>
DMC_DECL t3Vector<Elem_T> CompMin(const t3Vector<Elem_T>& v1, const t3Vector<Elem_T>& v2)
{
    return t3Vector<Elem_T>(std::min(v1.x,v2.x), std::min(v1.y,v2.y), std::min(v1.z,v2.z));
}

template<class Elem_T>
DMC_DECL t3Vector<Elem_T> CompMax(const t3Vector<Elem_T>& v1, const t3Vector<Elem_T>& v2)
{
    return t3Vector<Elem_T>(std::max(v1.x,v2.x), std::max(v1.y,v2.y), std::max(v1.z,v2.z));
}

template<class Elem_T>
DMC_DECL t3Vector<Elem_T> CompMult(const t3Vector<Elem_T>& v1, const t3Vector<Elem_T>& v2)
{
    return t3Vector<Elem_T>(v1.x*v2.x, v1.y*v2.y, v1.z*v2.z);
}

template<class Elem_T>
DMC_DECL t3Vector<Elem_T> CompDiv(const t3Vector<Elem_T>& v1, const t3Vector<Elem_T>& v2)
{
    return t3Vector<Elem_T>(v1.x/v2.x, v1.y/v2.y, v1.z/v2.z);
}
...
template<class Elem_T>
DMC_DECL std::ostream& operator<<(std::ostream& os, const t3Vector<Elem_T>& v)
{
    os << '[' << v.x << ", " << v.y << ", " << v.z << ']';
...
template<class Elem_T>
DMC_DECL std::istream& operator>>(std::istream& is, t3Vector<Elem_T>& v)
{
    Elem_T x, y, z;
    char st;
...
template<class Elem_T>
DMC_DECL Elem_T Dot(const t3Vector<Elem_T>& v1, const t3Vector<Elem_T>& v2)
{
    return v1.x*v2.x+v1.y*v2.y+v1.z*v2.z;
}

template<class Elem_T>
DMC_DECL t3Vector<Elem_T> Cross(const t3Vector<Elem_T>& v1, const t3Vector<Elem_T>& v2)
{
...
template<class Elem_T>
DMC_DECL t3Vector<Elem_T> LinearInterp(const t3Vector<Elem_T>& v1, const t3Vector<Elem_T>& v2, Elem_T t)
{
...
template<class Elem_T>
DMC_DECL t3Vector<Elem_T> CubicInterp(const t3Vector<Elem_T>& v1, const t3Vector<Elem_T>& v2, Elem_T f)
{
    Elem_T t = f*f*(3-2*f);
...
template<class Elem_T>
DMC_DECL void ComputePlane(const t3Vector<Elem_T> &V0, const t3Vector<Elem_T> &V1, const t3Vector<Elem_T> &V2,
...
template<class Elem_T>
DMC_DECL Elem_T TriangleArea(const t3Vector<Elem_T> &P0, const t3Vector<Elem_T> &P1, const t3Vector<Elem_T> &P2)
{
...
template<class Elem_T>
DMC_DECL t3Vector<Elem_T> MakeDRand(const Elem_T low=0, const Elem_T high=1)
{
...
// Return a uniformly distributed random point in the domain
template<class Elem_T>
DMC_DECL t3Vector<Elem_T> MakeDRand(const t3Vector<Elem_T> low, const t3Vector<Elem_T> high)
{
...
template<class Elem_T>
DMC_DECL t3Vector<Elem_T> MakeNRand(const Elem_T sigma = 1)
{
...
template<class Elem_T>
t3Vector<Elem_T> MakeRandOnSphere()
{
...
template<class Elem_T>
t3Vector<Elem_T> norm2d(const Elem_T x, const Elem_T y)
{
...
template<class Elem_T>
DMC_DECL bool length2_less(const t3Vector<Elem_T>& v1, const t3Vector<Elem_T>& v2)
{
...
template<class Elem_T>
DMC_DECL bool VecEq(const t3Vector<Elem_T> &V0, const t3Vector<Elem_T> &V1, const Elem_T &DSqr = 0.0)
{
...
template<class Elem_T>
DMC_DECL Elem_T t3Vector<Elem_T>::length2() const
{
    return x*x+y*y+z*z;
}

template<class Elem_T>
DMC_DECL t3Vector<Elem_T> t3Vector<Elem_T>::operator*(const Elem_T s) const
{
    return t3Vector<Elem_T>(x*s, y*s, z*s);
}

template<class Elem_T>
DMC_DECL t3Vector<Elem_T> t3Vector<Elem_T>::operator/(const Elem_T d) const
{
...
template<class Elem_T>
DMC_DECL t3Vector<Elem_T> t3Vector<Elem_T>::operator+(const t3Vector<Elem_T>& v) const
{
...
template<class Elem_T>
DMC_DECL t3Vector<Elem_T>& t3Vector<Elem_T>::operator+=(const t3Vector<Elem_T>& v)
{
    x+=v.x;
    y+=v.y;
    z+=v.z;
...
template<class Elem_T>
DMC_DECL t3Vector<Elem_T> t3Vector<Elem_T>::operator-() const
{
    return t3Vector<Elem_T>(-x, -y, -z);
}

template<class Elem_T>
DMC_DECL t3Vector<Elem_T>& t3Vector<Elem_T>::operator*=(const Elem_T d)
{
    x*=d;
    y*=d;
    z*=d;
...
template<class Elem_T>
DMC_DECL bool t3Vector<Elem_T>::operator==(const t3Vector<Elem_T>& v) const
{
