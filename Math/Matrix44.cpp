...
template <class Fl_T>
void Matrix44<Fl_T>::build_identity(Fl_T m[4][4]) const
{
...
template <class Fl_T>
void Matrix44<Fl_T>::build_scale(Fl_T m[4][4], const t3Vector<Fl_T>& v) const
{
    build_identity(m);
    m[0][0]=v.x;
    m[1][1]=v.y;
...
template <class Fl_T>
void Matrix44<Fl_T>::build_translate(Fl_T m[4][4], const t3Vector<Fl_T>& v) const
{
    build_identity(m);
    m[0][3]=v.x;
    m[1][3]=v.y;
...
template <class Fl_T>
void Matrix44<Fl_T>::build_rotate(Fl_T m[4][4], Fl_T angle, const t3Vector<Fl_T>& naxis) const
{
...
template <class Fl_T>
bool Matrix44<Fl_T>::build_inverse(Fl_T m[4][4]) const
{
    Fl_T p[4][4];
    build_identity(p);
...
template <class Fl_T>
void Matrix44<Fl_T>::build_transpose(Fl_T m[4][4]) const
{
    Fl_T t;
...
template <class Fl_T>
void Matrix44<Fl_T>::post_mulmat(Fl_T to[4][4], const Fl_T from[4][4])
{
    Fl_T newmat[4][4];
    for(int i=0; i<4; i++) {
        for(int j=0; j<4; j++) {
...
template <class Fl_T>
void Matrix44<Fl_T>::pre_mulmat(Fl_T to[4][4], const Fl_T from[4][4])
{
    Fl_T newmat[4][4];
    for(int i=0; i<4; i++) {
        for(int j=0; j<4; j++) {
...
template <class Fl_T>
std::string Matrix44<Fl_T>::string() const
{
    const int PRDIG = 8;
    char xx[40];
    std::string st;
...
template <class Fl_T>
std::string Matrix44<Fl_T>::string_inv() const
{
    const int PRDIG = 8;
    char xx[40];
    std::string st;
...
template <class Fl_T>
Fl_T Matrix44<Fl_T>::Determinant()
{
    return mat[0][0] * det3(0) - mat[0][1] * det3(1) +
        mat[0][2] * det3(2) - mat[0][3] * det3(3);
}
template float Matrix44<float>::Determinant();
template double Matrix44<double>::Determinant();

template <class Fl_T>
void Matrix44<Fl_T>::PostTrans(const Matrix44<Fl_T>& T)
{
    if(T.is_identity)
        return;
    if(is_identity) {
...
template <class Fl_T>
void Matrix44<Fl_T>::PreTrans(const Matrix44<Fl_T>& T)
{
    if(T.is_identity)
        return;
    if(is_identity) {
...
template <class Fl_T>
void Matrix44<Fl_T>::LoadFrame(const t3Vector<Fl_T>& x, const t3Vector<Fl_T>& y, const t3Vector<Fl_T>& z)
{
...
template <class Fl_T>
void Matrix44<Fl_T>::LoadFrame(const t3Vector<Fl_T>& x, const t3Vector<Fl_T>& y,
                         const t3Vector<Fl_T>& z, const t3Vector<Fl_T>& t)
{
    LoadFrame(x, y, z);
	inverse_valid = false;
...
template <class Fl_T>
void Matrix44<Fl_T>::GetFrame(t3Vector<Fl_T> &c0, t3Vector<Fl_T> &c1, t3Vector<Fl_T> &c2)
{
...
template <class Fl_T>
void Matrix44<Fl_T>::GetFrame(t3Vector<Fl_T> &c0, t3Vector<Fl_T> &c1, t3Vector<Fl_T> &c2, t3Vector<Fl_T> &c3)
{
...
template <class Fl_T>
void Matrix44<Fl_T>::ChangeBasis(const Matrix44<Fl_T>& T)
{
...
template <class Fl_T>
void Matrix44<Fl_T>::Scale(const t3Vector<Fl_T>& v)
{
    Fl_T m[4][4];
    build_scale(m, v);
    if(is_identity)
...
template <class Fl_T>
void Matrix44<Fl_T>::Rotate(Fl_T angle, const t3Vector<Fl_T>& axis)
{
    if(angle == 0)
        return;
...
template <class Fl_T>
void Matrix44<Fl_T>::Translate(const t3Vector<Fl_T>& v)
{
    Fl_T m[4][4];
    build_translate(m, v);
    if(is_identity)
...
void Matrix44<Fl_T>::Transpose()
{
    ...
    if(inverse_valid)
        build_transpose(imat);
}
template void Matrix44<float>::Transpose();
template void Matrix44<double>::Transpose();

template <class Fl_T>
void Matrix44<Fl_T>::Frustum(Fl_T l, Fl_T r, Fl_T b, Fl_T t, Fl_T n, Fl_T f)
{
    ASSERT_R(n>0 && f>0);
    Fl_T m[4][4];
...
template <class Fl_T>
void Matrix44<Fl_T>::Ortho(Fl_T l, Fl_T r, Fl_T b, Fl_T t, Fl_T n, Fl_T f)
{
    Fl_T m[4][4];
...
template <class Fl_T>
void Matrix44<Fl_T>::Perspective(Fl_T fovy, Fl_T aspect, Fl_T znear, Fl_T zfar)
{
...
template <class Fl_T>
void Matrix44<Fl_T>::LookAt(const t3Vector<Fl_T>& eye, const t3Vector<Fl_T>& lookat, const t3Vector<Fl_T>& up)
{
...
template <class Fl_T>
t3Vector<Fl_T> Matrix44<Fl_T>::Project(const t3Vector<Fl_T>& p) const
{
...
template <class Fl_T>
t3Vector<Fl_T> Matrix44<Fl_T>::Project(const t3Vector<Fl_T>& p, const Fl_T w) const
{
    // XXX Should I put an optimization here for is_identity?
...
template <class Fl_T>
void Matrix44<Fl_T>::Project(Fl_T &x, Fl_T &y, Fl_T &z, Fl_T &w) const
{
    // XXX Should I put an optimization here for is_identity?
...
template <class Fl_T>
t3Vector<Fl_T> Matrix44<Fl_T>::ProjectDirection(const t3Vector<Fl_T>& p) const
{
    // XXX Should I put an optimization here for is_identity?

    return t3Vector<Fl_T>(
...
template <class Fl_T>
t3Vector<Fl_T> Matrix44<Fl_T>::UnProject(const t3Vector<Fl_T>& p)
{
    // XXX Should I put an optimization here for is_identity?
...
template <class Fl_T>
bool Matrix44<Fl_T>::CheckNaN() const
{
    Fl_T *m = (Fl_T *)mat;
    for(int i=0; i<16; i++)
        ASSERT_RM(!dmcm::isNaN(m[i]), "Matrix has a NaN");
